...
const Select = ({
  ...
  return (
    <div
      ...
      className={`relative w-full z-10 select-none whitespace-nowrap ${disabled ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer'} ${className}`}
    ...
    >
      <div
        className={`flex items-center justify-between w-full px-4 py-2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-100 rounded transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:border-blue-500 dark:focus-visible:border-blue-400 whitespace-nowrap`}
        tabIndex={-1}
      >
