    ...
    <>
      ...
      <div style={dropdownStyle}>
        <div
          ...
          aria-labelledby={id}
          className={`rounded shadow-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-auto ${actualDirection === "up" ? "rounded-b-none" : "rounded-t-none"}`}
          style={{ maxHeight: dropdownStyle.maxHeight }}
        >
          {options.length === 0 && (
            <div className="px-4 py-2 text-gray-400 dark:text-gray-500">No options</div>
          )}
          {options.map((opt, i) => {
            ...
            return (
              <div
                ...
                className={`px-4 py-2 cursor-pointer whitespace-nowrap ${isActive
                    ...
                    : isSelected
                      ? "bg-blue-50 dark:bg-blue-800 font-semibold text-blue-700 dark:text-blue-200"
  ...
  return (
    <>
      <div
        ...
        {...props}
      >
        <div className="flex items-center justify-between w-full px-4 py-2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-100 rounded focus:outline-none">
          <span className={`${!selectedLabel ? "text-gray-400 dark:text-gray-500" : ""} whitespace-nowrap`}>
