          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700 mb-2 block">Organisation</label>
                  <Input
          ...
          <DialogContent className="max-w-md">
            ...
            {selectedUser && (
              <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-2">
                  <Button variant="outline" onClick={() => { setIsEditing(false); setSelectedUser(null); }}>
                    Cancel
                  </Button>
                  <Button
            ...
            {selectedUser && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-2 block">Organisation</label>
                    <Input value={selectedUser.organisation} disabled />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700 mb-2 block">Password</label>
                  <Input type="password" value={selectedUser.password} disabled />
                </div>
                <div className="flex justify-end space-x-2">
