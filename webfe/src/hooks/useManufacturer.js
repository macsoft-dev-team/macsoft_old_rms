import { fetchManufacturers, setManufacturer, setFilter } from "../lib/features/manufacturers";
import { useDispatch, useSelector } from "react-redux";
import { useEffect, useCallback } from "react";

export const useManufacturer = () => {
  const dispatch = useDispatch();
  const { manufacturers, manufacturer, currentPage, totalPages, filter, loading } =
